...
/// <summary>
/// Settings for validating Keycloak-issued JWTs. Separate from
/// <c>IdentityService.Infrastructure.Keycloak.KeycloakOptions</c> (which drives the Admin API client
/// and carries a client secret this side doesn't need) — this is the read-only, token-validation side.
/// </summary>
