...
/// header means anonymous. "X-Test-User-Id" lands in ClaimTypes.NameIdentifier: весь контроллер
/// берёт получателя из claim `sub`, так что без этого заголовка проверить изоляцию нельзя.
/// </summary>
