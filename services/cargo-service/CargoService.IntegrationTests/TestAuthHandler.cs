...
/// header means anonymous, which is what the public tracking endpoint needs to stay testable.
/// "X-Test-User-Id" lands in ClaimTypes.NameIdentifier — ShipmentsController takes the inspecting
/// employee from the `sub` claim rather than from the request body.
/// </summary>
