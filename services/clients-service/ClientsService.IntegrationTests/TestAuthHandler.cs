...
/// header means anonymous, matching how [Authorize]/[AllowAnonymous] behave for real. Unlike
/// identity-service's TestAuthHandler, this one also reads "X-Test-User-Id" into
/// ClaimTypes.NameIdentifier, since CounterpartiesController.GetUserId() relies on the `sub` claim
/// (mapped to NameIdentifier by the real JwtBearer handler) to scope data to the caller.
/// </summary>
