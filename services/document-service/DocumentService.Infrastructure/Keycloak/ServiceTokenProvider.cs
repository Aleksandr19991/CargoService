...
namespace DocumentService.Infrastructure.Keycloak;

/// <summary>
/// Выдаёт токен сервисной учётной записи document-service для вызовов в file-storage-service
/// (client_credentials в Keycloak) — тот же механизм, что у cargo-service (Фаза 11, задача 3).
/// <para>
